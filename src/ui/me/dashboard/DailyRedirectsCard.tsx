...
import { IUserDailyRedirectsResponse } from "@/types";
...
export default async function DailyRedirectsCard() {
  ...
  const res = await axios.get<IUserDailyRedirectsResponse>("/me/redirects", {
    headers: {
